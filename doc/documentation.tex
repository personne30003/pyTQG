...
\section{Models}
Note : \verb|beta| ($\beta$-plan approcimation) is a common parameter for all models
...
\end{itemize}
\subsection{Thermal Quasi-Geostrophic (class \texttt|BarotropicQG|)}
...
\subsection{Coupled Thermal Quasi-Geostrophic (class \texttt|BarotropicQG|)}
\subsubsection{Equations}
\subsubsection{Diagnostics}
\subsubsection{Parameters}
